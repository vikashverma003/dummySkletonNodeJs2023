...
router.get('/lte_dashboard', function(req, res, next) {
  //console.log("0000");
  res.render('lte/lte_dashboard');

});

router.get('/lte_login', function(req, res, next) {
  //console.log("0000");
  res.render('lte/lte_login', { title: 'Login Form',msg:'',loginUser:''});

});

router.get('/lte_register', function(req, res, next) {
  //console.log("0000");
  res.render('lte/lte_register', { title: 'Signup Form',msg:'',loginUser:'' });

});

router.get('/lte_add_category', function(req, res, next) {
  //console.log("0000");
  res.render('lte/lte_add_category');

});

router.get('/lte_invoice', function(req, res, next) {
  //console.log("0000");
  res.render('lte/lte_invoice');
...
router.get('/', function(req, res, next) {
  ...
  res.render('index', { title: 'Login Form',msg:'',loginUser:''});
    ...
    return res.redirect('/add-new-category');
